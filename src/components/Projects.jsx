...
export default function Projects() {
  ...
  return (
    <section ref={sectionRef} className="py-20 bg-gray-50 relative overflow-hidden" id="projects">
      {/* Background Pattern */}
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={project.title}
              className={`group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 transform hover:-translate-y-3 ${
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <div className="flex gap-4">
                    <a
                      ...
                      className="flex items-center justify-center w-12 h-12 bg-white/90 rounded-full text-gray-900 hover:bg-white transition-colors duration-200"
                      title="View Live"
                    >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 pt-4 border-t border-gray-100">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 group/btn inline-flex items-center justify-center px-4 py-2 bg-gray-900 text-white text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-50 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  >
                    Code
                  </a>
                </div>
        ...
        {/* Projects Stats */}
        <div className={`mt-16 bg-white rounded-2xl p-8 shadow-sm border border-gray-200 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-gray-900 mb-2">
                {projectList.filter(p => p.category === 'Frontend').length + projectList.filter(p => p.category === 'Backend').length}
              </div>
